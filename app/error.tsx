        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <CardContent className="pt-8 pb-8">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Xəta baş verdi</h1>
              <p className="text-lg text-gray-600 mb-6">
                Təəssüf ki, gözlənilməz bir xəta baş verdi. Lütfən yenidən cəhd edin.
              </p>
              ...
              <div className="text-left max-w-md mx-auto mb-8">
                <h3 className="font-semibold text-gray-700 mb-3">Nə baş verdi?</h3>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 bg-red-400 rounded-full mt-2 flex-shrink-0"></span>
                    Serverdə texniki problem yarandı
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 bg-red-400 rounded-full mt-2 flex-shrink-0"></span>
                    Məlumat bazası ilə əlaqə kəsildi
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 bg-red-400 rounded-full mt-2 flex-shrink-0"></span>
          ...
          >
            <CardContent className="pt-6 pb-6">
              ...
              <p className="text-sm text-red-700 mb-4">
                Problem davam edərsə, bizim dəstək komandamızla əlaqə saxlayın
              </p>
