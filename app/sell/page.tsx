...
export default function SellPage() {
  ...
  useEffect(() => {
    if (profileData) setFormData((p) => ({ ...p, userId: profileData.id }))
  }, [profileData])
  ...
  const colors = [
    "Qara", "Ağ", "Gümüşü", "Boz", "Qırmızı", "Mavi", "Yaşıl", "Sarı", "Narıncı", "Qəhvəyi", "Bej", "Qızılı", "Bənövşəyi", "Lavanda",
    "Çəhrayı", "Bordo", "Tünd Mavi", "Zeytun", "Göy", "Türkuaz", "Magenta", "Krem", "Şaftalı", "Tan", "Şokolad", "Bürünc", "Gül",
    "Nanə", "Aprikot", "Kömür Boz", "Teal", "Indigo", "Smaragd", "Safir", "Rubin", "Amber", "Qum", "Pas", "Jad", "Alabaster", "Opal", "Qrafit"
  ]
  const bodyTypes = [
    "Sedan", "Hatchback", "SUV", "Crossover", "Coupe", "Convertible", "Van", "Minivan", "Pickup", "Wagon", "City car", "Microcar",
    "Roadster", "Targa", "Shooting Brake", "Fastback", "Liftback", "Panel Van", "Box Truck", "Crew Cab", "Extended Cab"
  ]
  const engineOptions = [
    "0.6L", "0.8L", "1.0L", "1.2L", "1.3L", "1.4L", "1.5L", "1.6L", "1.8L", "2.0L", "2.2L", "2.4L", "2.5L", "3.0L", "3.5L", "4.0L", "4.4L",
    "5.0L", "6.0L", "Electric (kW)", "Hybrid (mild)", "Plug-in Hybrid", "Rotary", "Diesel Turbo", "Bi-Turbo", "Twin-Turbo"
  ]
  const cities = [
    "Bakı", "Gəncə", "Sumqayıt", "Mingəçevir", "Lənkəran", "Şəki", "Quba", "Naxçıvan", "Yevlax", "Tovuz", "Naftalan", "Qəbələ", "Salyan",
    "Biləsuvar", "Masallı", "Şamaxı", "Saatlı", "Bərdə", "Füzuli", "Cəlilabad", "Qazax", "Sabirabad", "Zaqatala", "Ağsu", "Oğuz", "Tərtər"
  ]
  const features = [
    "ABS", "EBD (Elektron əyləc paylanması)", "ESP/ESC", "Traction Control", "Airbags (Ön)", "Airbags (Yan)", "Curtain Airbags",
    "Kolliziya xəbərdarlığı", "Avtomatik təcili əyləc (AEB)", "Təkər təzyiqi monitorinqi (TPMS)", "Dəyişən yol köməyi (Hill Descent Control)",
    "Yüksək yamacda enmə köməyi", "Ölü nöqtə monitorinqi (BSM)", "Zolaq kömək sistemi (Lane Assist)", "Zolaq saxlama yardımçısı",
    "Tire Pressure Monitor", "Adaptive Headlights", "Night Vision", "Roll-over Protection", "Pedestrian Detection", "Driver Attention Alert",
    "Blind Spot Intervention", "Rear Cross Traffic Alert", "Tyre Pressure Warning", "ISO-FIX Child Anchors", "Lane Keep Assist", "Traffic Sign Recognition",
    "Kondisioner (Manuel)", "Avtomatik İqlim Nəzarəti (Dual-Zone)", "Avtomatik İqlim (Tri-Zone)", "Heated Seats (İsitməli oturacaqlar)",
    "Ventilated Seats (Sərinlənən oturacaqlar)", "Massaging Seats", "Memory Seats", "Leather Upholstery (Dəri salon)",
    "Fabric Upholstery", "Alcantara Trim", "Heated Steering Wheel", "Ventilated Steering Wheel", "Power Seats", "Electric Lumbar Support",
    "Rear Seat Recline", "Rear Armrest", "Rear Climate Control", "Sunroof", "Panoramic Sunroof", "Power Sunshade", "Ambient Lighting",
    "Wireless Phone Charger", "Cup Holders", "Center Console Storage", "Adjustable Steering Column", "Keyless Entry", "Push Button Start",
    "Remote Start", "Hands-free Tailgate", "Power Tailgate", "Soft-close Doors", "Noise Insulation Package", "Cabin Air Purifier",
    "Touchscreen Display", "Apple CarPlay", "Android Auto", "Built-in Navigation", "Satellite Navigation", "Bluetooth", "In-car WiFi",
    "Adaptive Sound System", "Premium Sound System (Bose/ Harman/ Bang & Olufsen)", "Multiple USB Ports", "12V Socket", "HD Radio",
    "DAB+", "Voice Recognition", "OTA Updates", "Telematics Service", "Connected Car Services", "Driver Profiles", "Over-the-air Maps",
    "In-car Apps", "Rear Entertainment System", "Head-up Display (HUD)", "Instrument Cluster LCD", "Gesture Control", "Wireless Mirroring",
    "Rear Camera", "Front Camera", "360 Degree Camera", "Parking Sensors (Front)", "Parking Sensors (Rear)", "Autonomous Parking",
    "Rear View Mirror Camera", "Top-view Camera", "Park Assist", "Trailer Assist", "Bird's Eye View", "Rear Cross Traffic Braking",
    "LED Headlights", "Xenon Headlights", "Matrix LED", "Adaptive LED Headlights", "Daytime Running Lights (DRL)", "Automatic Headlights",
    "Cornering Lights", "Fog Lights", "LED Tail Lights", "Roof Rails", "Panoramic Roof", "Power Folding Mirrors", "Heated Mirrors",
    "Auto-dimming Mirrors", "Rain-sensing Wipers", "Electric Windows", "Privacy Glass", "Tinted Glass", "Sunshade", "Spoiler", "Diffuser",
    "Sport Mode", "Eco Mode", "Adaptive Suspension", "Air Suspension", "Magnetic Ride Control", "Limited Slip Differential",
    "Active Aero", "Launch Control", "Torque Vectoring", "Four Wheel Drive", "All Wheel Drive", "Rear Wheel Drive", "Front Wheel Drive",
    "Adjustable Ride Height", "Performance Brakes", "Brembo Brakes", "Ceramic Brakes", "Regenerative Braking", "Start/Stop System",
    "Alloy Wheels", "Run-flat Tires", "TPMS", "Tire Repair Kit", "Wheel Size 15\"", "Wheel Size 16\"", "Wheel Size 17\"", "Wheel Size 18\"",
    "Wheel Size 19\"", "Wheel Size 20\"", "Wheel Size 21\"", "Snow Tires Included", "Off-road Tires", "Sport Tires", "Spare Wheel",
    "Roof Box Compatible", "Tow Hitch", "Tow Package", "Fold-flat Rear Seats", "Underfloor Storage", "Hands-free Liftgate",
    "Remote Trunk Release", "Adjustable Cargo Floor", "Cargo Net", "Roof Rails", "Bike Rack Prep", "Trailer Hitch",
    "Dual-zone Climate", "Tri-zone Climate", "Cabin Pre-heater", "Eco Driving Indicator", "Start-Stop System", "Low Emissions",
    "Euro 6 Compliant", "ULEZ Compliant", "AdBlue System", "Particulate Filter", "CO2 Low Emission",
    "Adaptive Cruise Control", "Full-Speed Adaptive Cruise", "Traffic Jam Assist", "Highway Assist", "Autonomous Emergency Steering",
    "Automatic Lane Change", "Hands-free Driving Mode", "Driver Monitoring", "Child Seat Recognition", "Rear Occupant Alert",
    "Floor Mats (All-weather)", "Cargo Cover", "Illuminated Sill Plates", "Ambient Lighting Customizable", "Wood Trim", "Carbon Fiber Trim",
    "Aluminum Pedals", "Sport Steering Wheel", "Heated Rear Seats", "Ventilated Rear Seats", "Refrigerated Glovebox",
    "Alarm System", "Immobilizer", "GPS Tracking", "Wheel Locking Bolts", "PIN to Drive", "Remote Vehicle Disable",
    "Keyless-Go", "Valet Mode", "Anti-theft Wheel Locks", "Central Locking",
    "Hill Start Assist", "Hill Descent Control", "Skid Plates", "Off-road Mode", "4x4 Low Range", "Tow Package with Wiring",
    "Trailer Sway Control", "Rear Differential Lock", "Roof Racks", "Underbody Protection",
    "Winter Package", "Summer Package", "Sport Package", "Technology Package", "Luxury Package", "Cold Climate Package",
    "Premium Paint", "Extended Warranty", "Service Plan Included", "Dealer Installed Options", "Owner's Manual in English/AZ",
    "First Aid Kit", "Fire Extinguisher", "Roadside Assistance Included"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Car className="h-5 w-5" />{pageContent.carInfo}</CardTitle>
              </CardHeader>
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="brand">{t("brand") || (language === "az" ? "Marka" : "Brand")}</Label>
                  <Select value={formData.brand} required onValueChange={(val) => setFormData((p) => ({ ...p, brand: val, model: "" }))}>
                    <SelectTrigger>
                ...
                <div>
                  ...
                  {modelsForSelectedBrand.length > 0 ? (
                    <Select value={formData.model} required onValueChange={(v) => setFormData((p) => ({ ...p, model: v }))}>
                      <SelectTrigger><SelectValue placeholder={language === "az" ? "Model seçin" : "Select model"} /></SelectTrigger>
                      <SelectContent>
                        {modelsForSelectedBrand.map((m) => <SelectItem key={m} value={m}>{m}</SelectItem>)}
                      </SelectContent>
                    </Select>
                  ) : (
                ...
                <div>
                  ...
                  <Select value={formData.year} onValueChange={(v) => setFormData((p) => ({ ...p, year: v }))} required>
                    <SelectTrigger><SelectValue placeholder={t("selectYear") || (language === "az" ? "İl seçin" : "Select year")} /></SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Select value={formData.condition} onValueChange={(v) => setFormData((p) => ({ ...p, condition: v }))} required>
                    <SelectTrigger><SelectValue placeholder={t("selectCondition") || (language === "az" ? "Vəziyyət seçin" : "Select condition")} /></SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Select value={formData.color} onValueChange={(v) => setFormData((p) => ({ ...p, color: v }))} required>
                    <SelectTrigger><SelectValue placeholder={t("selectColor") || (language === "az" ? "Rəng seçin" : "Select color")} /></SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Select value={formData.ban} onValueChange={(v) => setFormData((p) => ({ ...p, ban: v }))}>
                    <SelectTrigger><SelectValue placeholder={language === "az" ? "Karoseriya növü seçin" : "Select body type"} /></SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Select value={formData.engine} onValueChange={(v) => setFormData((p) => ({ ...p, engine: v }))}>
                    <SelectTrigger><SelectValue placeholder={language === "az" ? "Mühərrik seçin" : "Select engine"} /></SelectTrigger>
                    <SelectContent>
                      {engineOptions.map((eng) => <SelectItem key={eng} value={eng}>{eng}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
                <div>
                  ...
                  <Select value={formData.gearbox} onValueChange={(v) => setFormData((p) => ({ ...p, gearbox: v }))}>
                    <SelectTrigger><SelectValue placeholder={language === "az" ? "Qutu seçin" : "Select gearbox"} /></SelectTrigger>
                    <SelectContent>
                      {gearboxOptions.map((g) => <SelectItem key={g} value={g}>{g}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
                <div>
                  ...
                  <Select value={formData.location} onValueChange={(v) => setFormData((p) => ({ ...p, location: v }))} required>
                    <SelectTrigger><SelectValue placeholder={t("selectCity") || (language === "az" ? "Şəhər seçin" : "Select city")} /></SelectTrigger>
                    <SelectContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-h-[420px] overflow-auto p-2">
                  {features.map((feature) => (
                    <div key={feature} className="flex items-center space-x-2">
                      <Checkbox id={feature} checked={formData.features.includes(feature)} onCheckedChange={(checked) => handleFeatureChange(feature, checked as boolean)} />
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Camera className="h-5 w-5" />{pageContent.images}</CardTitle>
                        ...
                        {images.map((image, index) => (
                          <div key={image.id} className="relative group bg-white rounded-lg border shadow-sm overflow-hidden">
                            <div className="aspect-video relative">
                              ...
                              {index === 0 && <div className="absolute top-2 left-2 bg-blue-600 text-white px-2 py-1 rounded text-xs font-medium">{pageContent.mainImage}</div>}
                            ...
                            <div className="p-3">
                              ...
                              <div className="flex items-center justify-between mt-2">
                                ...
                                <div className="flex gap-1">
                                  {index > 0 && <Button type="button" size="sm" variant="ghost" className="h-6 w-6 p-0" onClick={() => moveImage(index, index - 1)}>←</Button>}
                                  {index < images.length - 1 && <Button type="button" size="sm" variant="ghost" className="h-6 w-6 p-0" onClick={() => moveImage(index, index + 1)}>→</Button>}
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><User className="h-5 w-5" />{pageContent.contactInfo}</CardTitle>
              </CardHeader>
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
            ...
            <Card>
              ...
              <CardContent>
                <Textarea value={formData.description} onChange={(e) => setFormData((p) => ({ ...p, description: e.target.value }))} placeholder={language === "az" ? "Avtomobil haqqında ətraflı məlumat..." : "Detailed information about the car..."} rows={4} />
              </CardContent>
            </Card>
